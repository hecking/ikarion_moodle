 ...
 * @access       public
 */
class HTML_QuickForm_modadvcheckbox extends HTML_QuickForm_checkbox
{
    // {{{ properties
     ...
     * @return    void
     */
    function HTML_QuickForm_modadvcheckbox($elementName=null, $elementLabel=null, $text=null, $attributes=null, $values=null, $valueid=null)
    {
