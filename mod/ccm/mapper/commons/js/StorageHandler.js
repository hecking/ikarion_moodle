...
(function() {
  ...
  */
    ...
    MoodleStorageHandler.prototype.createResource = function(content, cb) {
      ...
      try {
        resource = this.getResourceBundle(content);
        var jayson = JSON.stringify(resource);
        ...
        return $.ajax({
          ...
          success: function(responseData, textStatus, jqXHR) {
            ...
            //var datatoo = JSON.parse(responseData);
            //console.log(responseData);
            //console.log(JSON.stringifiy(data.metadata,undefined,2));
            console.log(responseData);
            //console.log(JSON.parse(responseData).content);
    ...
    MoodleStorageHandler.prototype.logAction = function(activityObject) {
      ...
      try {
        ...
        console.log("action: " + JSON.stringify(activityObject));
    ...
    MoodleStorageHandler.prototype.listResourceMetaDatas = function(cb) {
      var error;
      try {
        return $.ajax({
          type: "POST",
          data: {action: 'listResourceMetaDatas'},
          url: "" + this.urlPrefix + "/lib.php",
    ...
    MoodleStorageHandler.prototype.listResourceIds = function(cb) {
