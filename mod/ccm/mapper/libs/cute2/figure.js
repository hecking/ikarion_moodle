...
(function() {
    ...
    Figure.prototype.print_tree = function(depth) {
        ...
        { if (typeof(console) === 'undefined') { if (typeof(navigator) === 'undefined') print(tab + display + ' [' + fig.area() + '] ' + fig); } else console.log(tab + display + ' [' + fig.area() + '] ' + fig); };
    ...
    Figure.prototype.event = function(ev, ex, ey) {
        ...
        { if (typeof(console) === 'undefined') { if (typeof(navigator) === 'undefined') print('Figure.event ' + ev + c + ex + c + ey); } else console.log('Figure.event ' + ev + c + ex + c + ey); };
        ...
        if (f._active) {
            ...
            for (var i=grs.length; i>0; i--) {
                var gr = grs[i-1];
                { if (typeof(console) === 'undefined') { if (typeof(navigator) === 'undefined') print(i + '  ' + gr); } else console.log(i + '  ' + gr); };
                { if (typeof(console) === 'undefined') { if (typeof(navigator) === 'undefined') print('    displayed ' + gr._displayed); } else console.log('    displayed ' + gr._displayed); };
    ...
    Figure.prototype.geometry = function(x, y, w, h) {
        ...
        if (x != a._x || y != a._y) {
            ...
            if (!f._offset) {
                { if (typeof(console) === 'undefined') { if (typeof(navigator) === 'undefined') print('offset for ' + f + ' undefined'); } else console.log('offset for ' + f + ' undefined'); };
