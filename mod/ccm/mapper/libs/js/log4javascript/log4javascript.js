...
/* ---------------------------------------------------------------------- */
	...
	BrowserConsoleAppender.prototype.append = function(loggingEvent) {
		...
		var getFormattedMessage = function() {
			...
			return (typeof formattedMesage == "string") ? [formattedMessage] : formattedMessage;
		};
		...
		if ( (console = window.console) && console.log) { // Safari and Firebug
            ...
            if (typeof formattedMesage==="string"){
               formattedMesage = [formattedMesage]
            }
				console[consoleMethodName].apply(console, formattedMesage);
			} else {
				console[consoleMethodName](formattedMesage);
			}
