...
function showFrame() {
    $('#etherpad_activityframe').slideDown();

    $("#etherpad_iframe").contents().find("#page-header-wrapper").hide();
    $("#etherpad_iframe").contents().find("#page-navbar").hide();
    $("#etherpad_iframe").contents().find("#block-region-side-pre").hide();
    $("#etherpad_iframe").contents().find("#block-region-side-post").hide();
    $('.arrow-top').hide();

    //$("#etherpad_iframe").contents().find("#page-navbar").hide();
    //$("#etherpad_iframe").contents().find("#block-region-side-pre").hide();
    //$("#etherpad_iframe").contents().find("#block-region-side-post").hide();
    //$("#etherpad_iframe").contents().find("#region-main").attr("class","");
    //$("#etherpad_iframe").contents().find(".usermenu").hide();
    //$("#etherpad_iframe").contents().find("#page-footer").hide();
    //$("#etherpad_iframe").contents().find("#page-header-wrapper").hide();

}
function hideFrame() {
    $('#etherpad_activityframe').slideUp();
    $('.arrow-top').show();
}

function frame_loaded(obj) {
    $("#etherpad_iframe").contents().find("#page-header-wrapper").hide();
    $("#etherpad_iframe").contents().find("#page-navbar").hide();
    $("#etherpad_iframe").contents().find("#block-region-side-pre").hide();
    $("#etherpad_iframe").contents().find("#block-region-side-post").hide();
