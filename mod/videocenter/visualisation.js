...
function init(Y,jsony,ivid,icourse,videocenter){
    //init data
        ...
        onCreateLabel: function(domElement, node){
            ...
            domElement.onclick = function(){
                rgraph.onClick(node.id, {onComplete: function() {
                        if(node.data.type == 'video'){
                         $.get("loadmore.php", {id:node.id,c:node.data.course,vc:videocenter}, function(data){
                         ...
                         $.get("loadmoretags.php", {id:node.id,c:node.data.course,vc:videocenter}, function(data){
                          rgraph.loadJSON(data);
                          rgraph.refresh();
                        },"json");
    ...
    rgraph.loadJSON(jsony);

    /*
    $.get("loadmore.php", {id:ivid,c:icourse,vc:videocenter}, function(data){
                          rgraph.loadJSON(data);
