...
$context = context_course::instance($courseid); // deprecated: get_context_instance(CONTEXT_COURSE, $courseid);
...
// Hecking: Migration to new logging through the Event API
$event = \mod_videor\event\bookmark_created::create(array(
    'objectid' => $instanceid,
    'context' => $context
));
    $event->trigger();
