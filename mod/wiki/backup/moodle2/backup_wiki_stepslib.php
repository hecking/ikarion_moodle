...
class backup_wiki_activity_structure_step extends backup_activity_structure_step {
    ...
    protected function define_structure() {
        ...
        $page = new backup_nested_element('page', array('id'), array('title', 'cachedcontent', 'concepts', 'timecreated', 'timemodified', 'timerendered', 'userid', 'pageviews', 'readonly'));
        ...
        $version = new backup_nested_element('version', array('id'), array('content', 'contentformat', 'concepts', 'version', 'timecreated', 'userid'));
