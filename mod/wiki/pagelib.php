...
class page_wiki_diff extends page_wiki {
    ...
    function print_header() {
        ...
        echo html_writer::tag('div', get_string('comparewith', 'wiki', $vstring), array('class' => 'wiki_headingtitle2'));
    }
    ...
    private function print_diff_content() {
        ...
        //TODO This is where the difference network of two versions is build.
        //Create a network of the different versions.
        $conceptnetworkdiff = json_encode(mod_wiki_color_diff_versions(json_decode($newversion->concepts), json_decode($oldversion->concepts)));
        ...
        echo ("<script type=\"text/javascript\">var concepts = $conceptnetworkdiff, strings = $strings; </script> ");
